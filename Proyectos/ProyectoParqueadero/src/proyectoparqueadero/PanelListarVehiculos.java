...
public class PanelListarVehiculos extends javax.swing.JPanel {
    ...
    public void Eliminar (){
        ...
        //int FilaSelect = this.tblVehiculos.getSelectedRow();
                    
            //try{
                
                //Connection con = DriverManager.getConnection("jdbc:mysql://localhost/bdparqueadero", "root", "");
                //Statement stat = con.createStatement();
                //String sql = "DELETE FROM vehiculos WHERE id=?"+this.tipoVehiculo.getValueAt(FilaSelect, 0);
                //int n = stat.executeUpdate(sql);
                              
                //if(n>0){
                //    JOptionPane.showMessageDialog(null, "EL registro se elimino corectamente!!");
                //}else{
                //    JOptionPane.showMessageDialog(null, "EL registro no se elimino corectamente.\n" + "Intente nuevamente");                    
                //}
